...
// Original source https://github.com/goburrow/modbus/blob/master/crc.go
...
func (crc *crc) init(sysid uint16) *crc {
	crcInit := 0xFFFF - sysid
	crc.low = byte((crcInit >> 8) & 0xFF)
	crc.high = byte(crcInit & 0xFF)
	return crc
}
